    ...
    this.rotationTween = new Tween( {
      ...
      onComplete: () => {
        ...
        if ( ! scramble ) this.onMove();
          ...
          if (!scramble && this.dragDirection && this.dragDelta) {
          const direcao = this.dragDelta[this.dragDirection];
          if (this.dragDirection === 'x' || this.dragDirection === 'y') {
          sorakaFalaPorEixo(this.dragDirection, direcao);
  }
}
